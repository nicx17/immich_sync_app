...
- Added configurable masonry grid border width (0-50px) and custom border color with uniform edges (top, bottom, left, right and between tiles), auto-saved on change.
